...
namespace Game {
	...
	namespace MainMenu
	{
		...
		void showMenu()
		{
			...
			DrawText(FormatText("Version 1.0"), Game::HALF_SCREENWIDTH - (MeasureText("Version 1.0", FONT_SIZE_VERSION) / DIVIDER_MEASURE_TEXT), Game::SCREENHEIGHT / VERSION_LINE_DIVIDER + FONT_SIZE_OPTIONS, FONT_SIZE_VERSION, DARKGRAY);
