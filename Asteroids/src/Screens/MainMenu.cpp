...
namespace Game {
	...
	namespace MainMenu
	{
		...
		void showMenu()
		{
			...
			//DrawText(FormatText("2.Players"), Game::CALC_HALFSCREEN_WIDTH - (MeasureText("2.Players", FONT_SIZE_OPTIONS) / DIVIDER_MEASURE_TEXT), GamePlay::screenHeight / OPTIONS_LINE_DIVIDER + FONT_SIZE_OPTIONS, FONT_SIZE_OPTIONS, DARKGRAY);
