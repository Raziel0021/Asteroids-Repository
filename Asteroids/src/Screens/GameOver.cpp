	...
	namespace EndOfGame
	{
		...
		void showGameOver()
		{
			if (victory) 
			{
				...
				DrawText(FormatText("1.Menu"), Game::HALF_SCREENWIDTH - (MeasureText("1.Menu", FONT_SIZE_OPTIONS) / DIVIDER_MEASURE_TEXT), Game::SCREENHEIGHT / OPTIONS_LINE_DIVIDER + FONT_SIZE_TITLE, FONT_SIZE_OPTIONS, DARKGRAY);
				DrawText(FormatText("2.Salir"), Game::HALF_SCREENWIDTH - (MeasureText("2.Salir", FONT_SIZE_OPTIONS) / DIVIDER_MEASURE_TEXT), Game::SCREENHEIGHT / OPTIONS_LINE_DIVIDER + (FONT_SIZE_TITLE + FONT_SIZE_OPTIONS), FONT_SIZE_OPTIONS, DARKGRAY);
